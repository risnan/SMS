...
namespace Stock
{
...

    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "\r\n\r\n\r\n KINNIYA.THAMPALAHAMAM LIVESTOCK BREEDERS CO-OPERATIVE SOCIETY (LTD) \r\n\r\n";
            printer.SubTitle = "NO:TRY/385,SOORANKAL SANTHINAGAR ,\r\n KINNIYA. \r\n Phone:075 5051445 \r\n\r\n";
            printer.SubTitleFormatFlags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
            printer.PageNumbers = true;
            printer.PageNumberInHeader = false;
            printer.PorportionalColumns = false;
            printer.HeaderCellAlignment = StringAlignment.Near;
            printer.Footer = " Company Name:" + textBox6.Text + " \r\n" + " Date:" + dateTimePicker1.Value.ToString() + "\r\n" + " Unit_Price:" + textBox4.Text + "/=\r\n" + " Quantity:" + textBox5.Text + "\r\n" + " Total:" + label11.Text + "/=\r\n" + " Check No.:" + textBox2.Text + "\r\n" + "\r\n\r\n" + " Thank you for doing business with us.";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                new SqlCommand("insert into Product(ItemCode,ItemName,Type,OrginalPrice,SalePrice,Quantity) values('" + textBox6.Text + "')", con).ExecuteNonQuery();
                cmd.ExecuteNonQuery();
                con.Close();
                display1();
